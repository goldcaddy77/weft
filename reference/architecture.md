...
- [ ] **Activity completions: >30K/sec** (single node, SQLite) — measured ~18K/sec isolated subprocess median and roughly ~13-17K/sec across repeated full-suite verification reruns (post-optimization, up from ~9K/sec)
