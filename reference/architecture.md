...
- [x] **Worker spawn: <5ms** (Web Worker creation in Bun) — measured ~3ms isolated direct-run median; default full-suite regression gate calibrated to <7ms because test parallelism adds scheduler noise
