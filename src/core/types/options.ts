...
export interface ListFilter {
  ...
  /**
   * Match by `failureCategory` search attribute. Lowered into the existing
   * `attributes` index path at query time; included as a top-level field for
   * ergonomics and operator dashboards.
   */
